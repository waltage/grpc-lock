...
func (x *GCSMutex) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GCSMutex) ProtoMessage() {}

func (x *GCSMutex) ProtoReflect() protoreflect.Message {
	mi := &file_mutex_proto_msgTypes[0]
...
// Deprecated: Use GCSMutex.ProtoReflect.Descriptor instead.
func (*GCSMutex) Descriptor() ([]byte, []int) {
	return file_mutex_proto_rawDescGZIP(), []int{0}
}

func (x *GCSMutex) GetBucket() string {
	if x != nil {
		return x.Bucket
	}
	return ""
...
func (x *GCSMutex) GetObject() string {
	if x != nil {
		return x.Object
	}
	return ""
...
func (x *GCSMutex) GetGeneration() int64 {
	if x != nil {
		return x.Generation
	}
	return 0
...
func (x *GCSMutex) GetLockId() string {
	if x != nil {
		return x.LockId
	}
	return ""
...
func (x *GCSMutex) GetExpires() *timestamppb.Timestamp {
	if x != nil {
		return x.Expires
	}
	return nil
...
var file_mutex_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x6d, 0x75, 0x74, 0x65, 0x78, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x09, 0x67,
	0x72, 0x70, 0x63, 0x5f, 0x6c, 0x6f, 0x63, 0x6b, 0x1a, 0x1f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74,
	0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa9, 0x01, 0x0a, 0x08, 0x47, 0x43,
	0x53, 0x4d, 0x75, 0x74, 0x65, 0x78, 0x12, 0x16, 0x0a, 0x06, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74,
	...
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x17, 0x0a, 0x07, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x69,
	0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6c, 0x6f, 0x63, 0x6b, 0x49, 0x64, 0x12,
	0x34, 0x0a, 0x07, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
	0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x07, 0x65, 0x78,
	0x70, 0x69, 0x72, 0x65, 0x73, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_mutex_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_mutex_proto_goTypes = []interface{}{
	(*GCSMutex)(nil),              // 0: grpc_lock.GCSMutex
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_mutex_proto_depIdxs = []int32{
	1, // 0: grpc_lock.GCSMutex.expires:type_name -> google.protobuf.Timestamp
